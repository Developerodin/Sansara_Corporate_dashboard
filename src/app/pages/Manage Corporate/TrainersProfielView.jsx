            ...
            <div className='symbol symbol-100px symbol-lg-160px symbol-fixed position-relative'>
                {
                    ProfileData &&  
                    ProfileData.color ? (
                        <span className={`symbol-label bg-light-${ProfileData.color} text-${ProfileData.color} fs-5 fw-bolder`}>
                          {ProfileData.name.charAt(0)}
                        </span>
                      ) : (
                        ProfileData && <img src={toAbsoluteUrl(`${ProfileData.avatar}`)} alt='Metronic' />
                      )
                ...
                <div className='d-flex flex-wrap'>
                  <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3'>
                    <div className='d-flex align-items-center'>
                      ...
                      />
                      <div className='fs-2 fw-bolder'>{ProfileData && ProfileData.totalExperience}</div>
                    </div>
                  ...
                  <div className='border border-gray-300 border-dashed rounded min-w-125px py-3 px-4 me-6 mb-3'>
                    <div className='d-flex align-items-center'>
                      <KTSVG
                        ...
                        className='svg-icon-3 svg-icon-success me-2'
                      />
                      <div className='fs-2 fw-bolder'>{ProfileData && ProfileData.totalClasses}</div>
                    </div>
