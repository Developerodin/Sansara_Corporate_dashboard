      ...
      <div className='card-header' style={{padding:"0px"}}>
        <div className='card-title d-flex flex-column m-0'style={{backgroundColor:"#DCE2C8",width:"100%",height:"100px",padding:"20px"}}>
          <div className='d-flex align-items-center'>
            ...
            <span className='fs-2hx fw-bold text-dark me-2 lh-1 ls-n2 '>85</span>
          ...
          <span className='text-white-400 pt-1 fw-semibold fs-6'>Total Classes</span>
        </div>
      </div>
      ...
      <div className='card-body pt-2 pb-4 d-flex flex-wrap align-items-center p-05' style={{height:"190px"}}>
        ...
        <div className='d-flex flex-column content-justify-center flex-row-fluid'>
          <div className='d-flex fw-semibold align-items-center'>
            ...
            <div className='text-gray-500 flex-grow-1 me-4'>present</div>
            <div className='fw-bolder text-gray-700 text-xxl-end'>75 class</div>
          </div>
          <div className='d-flex fw-semibold align-items-center my-3'>
            <div className='bullet w-8px h-3px rounded-2 bg-primary me-3'></div>
            <div className='text-gray-500 flex-grow-1 me-4'>absent</div>
            <div className='fw-bolder text-gray-700 text-xxl-end'>10 class</div>
          </div>
